...
const scheduleEvents: ScheduleEvent[] = [
  ...
  },
  {
    ...
    type: "exhibition",
    description:
      "Выставка красочных космических фотографий, представленных профессиональными астрономами. Посетители смогут насладиться красотой космоса и узнать больше о космических объектах на фотографиях.",
    isRange: true,
  },
  {
    id: "3",
